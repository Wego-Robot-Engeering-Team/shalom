...
//     }
//
// declares a *new* type hmi::ui::QLabel rather than referring to Qt's QLabel.
...
private:
    ...
    {
        QStringList out;
        QDir root(QStringLiteral(HMI_SOURCE_DIR "/src"));
...
private slots:
    ...
    void headersExist()
    {
        QVERIFY2(!headerFiles().isEmpty(),
                 "헤더를 하나도 찾지 못했다 — HMI_SOURCE_DIR 설정을 확인할 것");
    }
